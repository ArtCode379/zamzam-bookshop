package shop.zamzambookshop.app.ui.composable.screen.checkout
...
import shop.zamzambookshop.app.ui.composable.shared.BottomButtonBox
...
private fun CheckoutContent(
    ...
    Column(modifier = modifier) {
        ...
        BottomButtonBox(
            onButtonClick = onPlaceOrderButtonClick,
            isButtonEnabled = isButtonEnabled,
            buttonText = stringResource(R.string.button_confirm_order_label),
        )
    }
}
